---
title: "Come Ottenere una QSL: Guida Step by Step per SWL"
date: 2026-03-12
draft: false
tags:
  - qsl
...
1. I tuoi dati: nome, indirizzo postale completo, paese.
2. I dati della ricezione: data, ora UTC, frequenza, banda, modo, SINPO, contenuto.
3. I dati del tuo setup: ricevitore (marca e modello), antenna, luogo di ricezione.
4. Una richiesta esplicita di QSL — alcune stazioni la inviano solo se la chiedi.
...
## Anteprima del template lettera

![Anteprima template lettera QSL](/images/preview-template-qsl-1.png)
...
<div style="text-align:center; margin: 2em 0;">
  <a href="/downloads/template-lettera-qsl-swl.pdf"
    ...
    📥 Scarica il Template Lettera QSL (.pdf)
  </a>
  <p style="font-size:0.8em; color:#666; margin-top:8px;">
    Formato PDF stampabile — A4, compilabile a penna o a macchina
  </p>
</div>
