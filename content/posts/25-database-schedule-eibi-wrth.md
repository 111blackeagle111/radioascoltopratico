---
title: "EIBI, WRTH e gli Altri: i Database Indispensabili per l'Ascoltatore"
date: 2026-03-12
draft: false
description: "Database e schedule radiofoniche: EIBI gratuito, WRTH annuale, ricerca frequenze per identificare stazioni sconosciute in tempo reale."
tags:
  - database
  - schedule
  - eibi
...
1. Si sente qualcosa di interessante su una frequenza
2. Si cerca la frequenza su EIBI o short-wave.info con l'ora UTC attuale
3. Si identificano le stazioni candidate → si conferma all'ascolto
4. Se la stazione è identificata e merita un rapporto, si consulta il sito della stazione per l'indirizzo QSL
5. Per approfondire il contesto (paese, storia della stazione, potenza trasmettitore), il WRTH dà informazioni che i database online non hanno
